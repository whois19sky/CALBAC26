...
// Experience management moved to Sanity Studio as of the CMS migration.
export default function ExperiencesManagerMovedNotice() {
  return (
    <div className="max-w-2xl mx-auto mt-12">
      <div className="bg-amber-50 border border-amber-200 rounded-2xl p-8 text-center">
        ...
        <h1 className="text-2xl font-serif text-dark mb-3">Experiences Have Moved</h1>
        <p className="text-dark/60 leading-relaxed mb-8">
          WanderXP experience management (pricing, photos, descriptions) now lives in your
