 ...
 */
export declare const getFirstMediaPlaylistUrl: (multivariantPlaylist: string) => string | undefined;
/**
 ...
 */
export declare const toAbsoluteUrl: (url: string, base?: string | URL) => URL;
