...
import type { PlaybackEngine, ExtensionMimeTypeMap, ValueOf, MaxResolutionValue, MinResolutionValue, RenditionOrderValue, MaxAutoResolutionValue, Chapter, CuePoint } from '@mux/playback-core';
...
export declare const Attributes: {
    ...
    readonly MAX_RECONNECT_RETRIES: "max-reconnect-retries";
    ...
    readonly TYPE: "type";
    readonly LOGO: "logo";
    readonly CAP_RENDITION_TO_PLAYER_SIZE: "cap-rendition-to-player-size";
    readonly INITIAL_BANDWIDTH_ESTIMATE_KBPS: "initial-bandwidth-estimate-kbps";
    readonly INITIAL_ESTIMATE_SEGMENTS: "initial-estimate-segments";
    readonly MIN_PRELOAD_SEGMENTS: "min-preload-segments";
};
...
export declare class MuxVideoBaseElement extends CustomVideoElement implements IMuxVideoBaseElement {
    ...
    get disablePseudoEnded(): boolean;
    set disablePseudoEnded(val: boolean);
    ...
    get maxAutoResolution(): MaxAutoResolutionValue | undefined;
