...
var MediaThemeElement = class extends GlobalThis.HTMLElement {
  constructor() {
    ...
    __privateAdd3(this, _observer, void 0);
    __privateAdd3(this, _renderBind, void 0);
    if (this.shadowRoot) {
    ...
    __privateSet3(this, _observer, new MutationObserver((mutationList) => {
      var _a3;
    ...
    __privateSet3(this, _renderBind, this.render.bind(this));
  ...
  connectedCallback() {
    this.addEventListener(
      ...
      __privateGet3(this, _renderBind)
    );
    __privateGet3(this, _observer).observe(this, { attributes: true });
    __privateGet3(this, _observer).observe(this.renderRoot, {
      attributes: true,
      subtree: true
    });
    __privateMethod(this, _updateTemplate, updateTemplate_fn).call(this);
  ...
  disconnectedCallback() {
    ...
    __privateGet3(this, _observer).disconnect();
  }
  createRenderer() {
...
var MediaChromeMenu = class extends GlobalThis.HTMLElement {
  ...
  disconnectedCallback() {
    var _a3, _b2;
    __privateGet4(this, _mutationObserver).disconnect();
    ...
    __privateSet4(this, _previouslyFocused, null);
    __privateSet4(this, _invokerElement, null);
...
var MediaChromeMenuItem = class extends GlobalThis.HTMLElement {
  constructor() {
    ...
    __privateAdd5(this, _handleKeyUp, (event) => {
      const { key } = event;
      if (!this.keysUsed.includes(key)) {
        this.removeEventListener("keyup", __privateGet5(this, _handleKeyUp));
        return;
      }
      this.handleClick(event);
    });
    __privateAdd5(this, _handleKeyDown2, (event) => {
      const { metaKey, altKey, key } = event;
      if (metaKey || altKey || !this.keysUsed.includes(key)) {
        this.removeEventListener("keyup", __privateGet5(this, _handleKeyUp));
        return;
      }
      this.addEventListener("keyup", __privateGet5(this, _handleKeyUp), { once: true });
    });
    if (!this.shadowRoot) {
      this.attachShadow(this.constructor.shadowRootOptions);
      const attrs = namedNodeMapToObject(this.attributes);
  ...
  handleEvent(event) {
    switch (event.type) {
      ...
      case "click":
        ...
        break;
      case "keydown":
        __privateGet5(this, _handleKeyDown2).call(this, event);
        break;
      case "keyup":
        __privateGet5(this, _handleKeyUp).call(this, event);
        break;
    }
  }
  attributeChangedCallback(attrName, oldValue, newValue) {
