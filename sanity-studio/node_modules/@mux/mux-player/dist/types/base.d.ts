...
import type { ValueOf, Metadata, PlaybackEngine, MaxResolutionValue, MinResolutionValue, RenditionOrderValue, MaxAutoResolutionValue, Chapter, CuePoint, Tokens } from '@mux/playback-core';
import VideoApiElement from './video-api';
import { AttributeTokenList } from './helpers';
import type { IMuxPlayerElement } from './types';
...
declare class MuxPlayerElement extends VideoApiElement implements IMuxPlayerElement {
     ...
     */
    get noMutedPref(): boolean;
    /**
     * Set no-muted-pref flag.
     */
    set noMutedPref(val: boolean);
    /**
